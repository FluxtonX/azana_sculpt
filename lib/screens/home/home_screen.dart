...
import '../workouts/workout_countdown_overlay.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          MessagesScreen(isActive: _currentIndex == 3),
          const ProfileScreen(),
        ],
      ),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              height: 440, // Ensure hit-test area covers the entire card
              child: Stack(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  const SizedBox(height: 10), // Reduced since card is now in bounds
                  ...
                  // Dynamic motivation card — replaces static quote
  ...
  Widget _buildHeader() {
    ...
    final nameForAvatar = (user?.displayName != null && user!.displayName!.isNotEmpty) 
        ? user!.displayName! 
        : 'User';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 6),
              const Text(
                'Day 32 of 90 • 90-Day Transformation',
                style: TextStyle(fontSize: 12, color: AppTheme.textLight),
              ),
              const SizedBox(height: 18),
              // Animated progress bar
              const AnimatedProgressBar(value: 0.35, height: 6),
              const SizedBox(height: 20),
              SizedBox(
                width: double.infinity,
  ...
  Widget _buildBottomNavigationBar() {
    ...
    return StreamBuilder<UserModel?>(
      ...
      builder: (context, userSnapshot) {
        ...
        // If no coach assigned, we simply show 0 unread
        if (coachId == null) {
          return _buildNavBarContent(0);
        }

        final chatId = '${uid}_$coachId';
        
        return StreamBuilder<int>(
          stream: DatabaseService().getChatUnreadCountStream(chatId, uid),
          builder: (context, countSnapshot) {
            final unreadCount = countSnapshot.data ?? 0;
            return _buildNavBarContent(unreadCount);
          }
        );
      }
    );
  ...
  Widget _buildNavBarContent(int unreadCount) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        boxShadow: [
      ...
      child: BottomNavigationBar(
        ...
        onTap: (index) {
          setState(() {
            _currentIndex = index;
            // Reload local image when returning to home tab or switching away
            _loadLocalImage();
          });
          if (index == 3) {
            _markMessagesAsRead();
